...
- 🔗 **Evidence dossiers committed** — `RESEARCH-2026-FRP.md`, `DEBATE-AI-VS-GOOGLE.md`, `docs/PHYSICS-LAYER-RESEARCH.md` (experimental: physics-layer + falsifiable patch forecasts, surfaced in-app as **FRP Lab 🧪 → Patch Oracle 🔮**)
