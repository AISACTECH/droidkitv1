...
- 🔗 **Evidence dossiers committed** — `RESEARCH-2026-FRP.md`, `DEBATE-AI-VS-GOOGLE.md`, `docs/PHYSICS-LAYER-RESEARCH.md`, `docs/RESCUE-LAB-RESEARCH.md` (experimental lanes: FRP Lab 🧪 Patch Oracle 🔮 + Rescue Lab 🛠️ multi-device repair bench — both under the bands-not-promises honesty law)
